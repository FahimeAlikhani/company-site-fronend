...
<section class="section">
  <div class="header-title">
        ...
        <div class="title-Horizontal-line"></div>
         <div class="title">
              <span style="color:#0B132A">مشاوره </span>
              <span style="color:#F53838">و برآورد پروژه</span>
          </div>
         <div class="title-Vertical-line"></div> 
     </div> 
          ...
          <form
             ...
             <div v-if="errored" class="">
              ...
              <div class="position-layer2">
                   <div class="text">
                       <p>ارائه مشاوره جهت انجام پروژه </p> 
                    </div>
                    <div class="input-box">
                    <div>
                          ...
                          <label for="message" class="label">توضیحات</label>
                             <div class="">
                               <textarea
                                  ...
                                  size="4"
                                  class="input"
                                  placeholder="توضیحات در مورد موضوع مشاوره"
                                 ></textarea>
                               </div>
                         </div>
                       <div class="btn-cta">
